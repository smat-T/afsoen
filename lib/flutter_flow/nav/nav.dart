...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'what_your_name',
          path: '/whatYourName',
          builder: (context, params) => WhatYourNameWidget(),
        ),
        FFRoute(
          name: 'date_of_birth',
          path: '/dateOfBirth',
        ...
        FFRoute(
          ...
          builder: (context, params) => UploadProfilePhotoWidget(),
        ),
        FFRoute(
          name: 'allDone',
          path: '/allDone',
        ...
        FFRoute(
          name: 'profileVideos',
          path: '/profileVideos',
          builder: (context, params) => ProfileVideosWidget(),
        ),
        FFRoute(
          name: 'chat',
          path: '/chat',
        ...
        FFRoute(
          ...
          path: '/reelsScreen',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'reelsScreen')
              : ReelsScreenWidget(),
        ),
        FFRoute(
          name: 'statusScreen',
        ...
        FFRoute(
          name: 'profilePhotos',
          path: '/profilePhotos',
          builder: (context, params) => ProfilePhotosWidget(),
        ),
        FFRoute(
          name: 'whoareYou',
          path: '/whoareYou',
